...
alter table "public"."leaderboard" drop column "highest_score";

alter table "public"."users" add column "username" text;

CREATE INDEX idx_game_id ON public.throws USING btree (game_id);

CREATE INDEX idx_user_id ON public.throws USING btree (user_id);
...
alter table "public"."users" add constraint "users_type_check" CHECK (((type)::text = ANY ((ARRAY['internal'::character varying, 'external'::character varying])::text[]))) not valid;
